...
export default function Meal() {
  ...
  const handleUpdateMeal = (mealId) => { //for the button injection
 ...
 const loadMeals = async () => {
  ...
  <Modal show={showDescription} onHide={handleCloseDescription}>
    ...
    <div className="container">
      ...
      <div className="list">
        Meal List:
      <Button onClick={handleShow} className="btn" data-toggle="modal"><i className="material-icons">&#xE147;</i> <span>Add new meal</span></Button>					
       </div> 
            ...
            {meals.map((meal, index) => (
              <tr key={index}>
                ...
                {<OverlayTrigger
                  ...
                  <button className='btn text-primary' onClick={() => handleViewMeal(meal.id)} data-toggle="modal">
                ...
                <OverlayTrigger
                    ...
                    <button onClick={() => handleUpdateMeal(meal.id)} className="btn  btn-act" data-toggle="modal" ><i className="material-icons icon2">&#xE254;</i></button>
                </OverlayTrigger>
                <OverlayTrigger
                    overlay={
                        <Tooltip id={`tooltip-top`}>
                    ...
                    <button  onClick={() => {setShowDeleteConfirmation(true); setMealToDeleteId(meal.id);}}  className="btn text-danger btn-act icon3" ><i className="material-icons">&#xE872;</i></button>
                </OverlayTrigger>
